...
import AthensRatingsDistribution from '../../components/charts/AthensRatingsDistribution.astro';
import RatingCompressionChart from '../../components/charts/RatingCompressionChart.astro';
...
<RatingCompressionChart kind="airbnb" />
...
<RatingCompressionChart kind="imdb" />
